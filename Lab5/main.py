...
Course.courses = [
    Course("Intelligence Systems", ["MI-4", "TK-4", "TTP-4"], "Hlybovets", ["Taranukha", "Fedorus", "Bugayov"]),
    Course("Machine Learning", ["MI-4"], "Radyvonenko"),
    Course("Image Recognition", ["MI-4"], "Ryabokon"),
    Course("Refactoring Problems", ["MI-4"], "Kulyabko"),
    Course("Management", ["MI-4", "TK-4", "TTP-4"], "Tymashoff", ["Vergunova"]),
    Course("QA", ["TTP-4"], "Kuzenko", ["Kuzenko", "Fedorova"]),
            ...
            for gr_value in values:
                if gr_value['slot'] == slot:
                    print("{}: {}, {} ({}) - {}".format(gr_value['slot'], gr_value['course'],
                                                            ...
                                                            'Practice' if gr_value['is_lab'] else 'Lecture'))
